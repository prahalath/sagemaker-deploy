...
tokenizer = AutoTokenizer.from_pretrained('saved_models/bert_tokenizer')
model = AutoModelForSequenceClassification.from_pretrained('saved_models/bert_model')
...
class HandlerService(DefaultHandlerService):
    ...
    def predict_fn(self, input_data, model_dict):
        ...
        data = str(np_array_input_data)
        # r = model_dict.predict(data)

        # Round the prediction results
        model_output = self.pred_sentiment(data)
